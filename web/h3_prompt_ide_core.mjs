...
export function editInstructionTemplate(context) {
    ...
    case "room_object_study":
        if (String(context.primaryImageRole ?? "").startsWith("generate |")) {
            return "Treat <Picture 1> and every additional connected picture as complementary Qwen-only survey views with equal semantic authority over the same physical room, not separate designs or source frames. No picture is the master, source, pixel anchor, composition anchor, or timeline frame; <Picture 1> has no priority merely because it is listed first. Reconcile repeated evidence across all views and use the clearest local observation only for the detail it reveals. Regenerate that recognizable room as a clean high-fidelity photorealistic reconstruction while preserving its architecture, dimensions, openings, fixtures, furniture, materials, lighting, and ordinary physical character. Target object: the primary freestanding object near the center of the room. Preserve its exact dimensions, silhouette, construction, material, seams or joinery, and fixed floor position. Lock the object to one world-space orientation: the same faces remain aimed toward the same doors, windows, walls, floorboards, and rug fibers; it never spins, turns, yaws, or pivots. Freeze the reconstructed world, then create six room-establishing views followed by ten contextual object views using instantaneous hard cuts. In every object view, keep the complete object at roughly 25 to 45 percent of the frame with its rug or floor contact and at least two recognizable room anchors visible. Background parallax must prove that only the camera changed position. Never create an isolated product shot, macro-only crop, blank background, or camera travel between views.";
        }
        return "Treat <Picture 1> and every additional connected picture as complementary views of the same physical room. Target object: the primary freestanding object near the center of the room. Freeze its exact dimensions, silhouette, construction, material, seams or joinery, floor position, and complete surrounding room. Lock the object to one world-space orientation relative to the same doors, windows, walls, floorboards, and rug fibers; it never spins, turns, yaws, or pivots. Create six room-establishing views followed by ten contextual object views using instantaneous hard cuts. Keep the complete object at roughly 25 to 45 percent of each object frame with its rug or floor contact and at least two recognizable room anchors visible. Background parallax must prove that only the camera changed position. Never create an isolated product shot, macro-only crop, blank background, or camera travel between views.";
    default:
        return "";
    }
}
